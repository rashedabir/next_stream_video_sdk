      ...
      >
        ...
        >
          ...
          >
            ...
            >
              ...
              >
                ...
                >
                  ...
                  {!isXSOnly && (
                    <Box
                      className="absolute bg-gray-700 rounded cursor-pointer md:left-52 lg:left-24 xl:left-44 md:right-52 lg:right-24 xl:right-44"
                      // style={{
                      //   position: "absolute",
                      //   display: "flex",
                      //   alignItems: "center",
            ...
            >
              <div className="flex flex-col items-center justify-center flex-1 w-full xl:m-16 lg:m-6 md:mx-44 md:mt-11 lg:mt-4">
